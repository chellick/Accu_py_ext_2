...
class WeatherModel:
    ...
    def convert_weather_data_to_dict(weather_data: list):
        ...
        weather_dict = {
            ...
            .get("Metric", {})
            .get("Value", None),
            "Apparent Temperature (°C)": weather.get("ApparentTemperature", {})
            .get("Metric", {})
            .get("Value", None),
            "Dew Point (°C)": weather.get("DewPoint", {})
            .get("Metric", {})
            .get("Value", None),
            "Wind Speed (km/h)": weather.get("Wind", {})
            .get("Speed", {})
            .get("Metric", {})
            .get("Value", None),
            "Wind Direction": weather.get("Wind", {})
            .get("Direction", {})
            .get("Localized", None),
            "Humidity (%)": weather.get("RelativeHumidity", None),
            "Precipitation Probability (%)": (
                100 if weather.get("HasPrecipitation", False) else 0
            ),
            "Cloud Cover (%)": weather.get("CloudCover", None),
            "Visibility (km)": weather.get("Visibility", {})
            .get("Metric", {})
            .get("Value", None),
            "Pressure (mb)": weather.get("Pressure", {})
            .get("Metric", {})
            .get("Value", None),
    ...
    def check_weather_params(self):
        ...
        if (
            temp is not None
            and temp < 5
            or wind_speed is not None
            and wind_speed > 20
            or precipitation_prob > 70
        ):
